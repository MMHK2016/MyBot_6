...
Func VillageSearch() ;Control for searching a village that meets conditions
	...
	While 1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;### Main Search Loop ###;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
		...
		ElseIf $match[$DB] And $dbBase Then
			...
			If $ichkDBMeetCollOutside = 1 And Not AreCollectorsOutside($iDBMinCollOutsidePercent) Then
				SetLog(GetTranslated(20,22, "Collectors are not outside!"), $COLOR_RED, "Lucida Console", 7.5)
			Else
				If $ichkDBMeetCollOutside = 1 And AreCollectorsOutside($iDBMinCollOutsidePercent) Then _
	...
	If $AlertSearch = 1 Then
		TrayTip("[ " & $sCurrProfile & " ] " & $sModeText[$iMatchMode] & " Match Found!", $SearchCount & "> Gold: " & $searchGold & "; Elixir: " & $searchElixir & "; Dark: " & $searchDark & "; Trophy: " & $searchTrophy, "", 0);MMHK add profile name and search # to tray tip
